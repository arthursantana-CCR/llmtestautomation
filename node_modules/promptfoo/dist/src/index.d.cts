...
declare const COLLECTIONS: readonly ["default", "foundation", "harmful", "pii", "bias", "medical", "pharmacy", "insurance", "financial", "ecommerce", "telecom", "realestate", "guardrails-eval"];
...
declare const CommandLineOptionsSchema: z.ZodObject<{
  ...
  filterPrompts: z.ZodOptional<z.ZodString>;
...
declare const UnifiedConfigSchema: z.ZodPipe<z.ZodObject<{
  ...
  commandLineOptions: z.ZodOptional<z.ZodObject<{
    ...
    filterPrompts: z.ZodOptional<z.ZodOptional<z.ZodString>>;
  ...
  commandLineOptions?: {
    ...
    filterPrompts?: string | undefined;
