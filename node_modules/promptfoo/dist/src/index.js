...
import { $ as riskCategorySeverityMap, A as isApiProvider, C as TestGeneratorConfigSchema, Ct as CompletionTokenDetailsSchema, D as VarsSchema, E as UnifiedConfigSchema, F as ConversationMessageSchema, G as STRATEGY_COLLECTIONS, I as PartialGenerationError, K as STRATEGY_COLLECTION_MAPPINGS, L as PluginConfigSchema, M as RedteamConfigSchema, O as isGradingResult, P as ProvidersSchema, R as PolicyObjectSchema, S as TestCasesWithMetadataSchema, St as BaseTokenUsageSchema, T as TestSuiteSchema, U as DEFAULT_STRATEGIES, X as Severity, Y as isFanoutStrategy, Z as categoryAliases, _ as ScenarioSchema, _t as REMOTE_ONLY_PLUGIN_IDS, a as AtomicTestCaseSchema, at as FOUNDATION_PLUGINS, b as TestCaseWithVarsFileSchema, bt as UNALIGNED_PROVIDER_HARM_PLUGINS, c as CompletedPromptSchema, ct as LLAMA_GUARD_ENABLED_CATEGORIES, d as EvaluateOptionsSchema, dt as MULTI_INPUT_EXCLUDED_PLUGINS, et as ALIASED_PLUGIN_MAPPINGS, f as GradingConfigSchema, ft as MULTI_INPUT_VAR, g as ResultFailureReason, gt as REDTEAM_PROVIDER_HARM_PLUGINS, h as OutputFileExtension, ht as PLUGIN_CATEGORIES, i as AssertionTypeSchema, it as FINANCIAL_PLUGINS, j as isProviderOptions, k as isResultFailureReason, l as DerivedMetricSchema, lt as LLAMA_GUARD_REPLICATE_PROVIDER, m as OutputConfigSchema, mt as PII_PLUGINS, n as AssertionSchema, nt as DATASET_EXEMPT_PLUGINS, o as BaseAssertionTypesSchema, ot as HARM_PLUGINS, p as NotPrefixedAssertionTypesSchema, pt as PHARMACY_PLUGINS, q as getDefaultNFanout, r as AssertionSetSchema, rt as DEFAULT_PLUGINS, s as CommandLineOptionsSchema, st as INSURANCE_PLUGINS, t as AssertionOrSetSchema, tt as BIAS_PLUGINS, u as EvalResultsFilterMode, ut as MEDICAL_PLUGINS, v as SpecialAssertionTypesSchema, w as TestSuiteConfigSchema, wt as InputsSchema, x as TestCasesWithMetadataPromptSchema, xt as PromptSchema, y as TestCaseSchema, yt as TELECOM_PLUGINS, z as StrategyConfigSchema } from "./types-BsU_PxR3.js";
...
import { F as getShareViewBaseUrl, L as VERSION, M as TERMINAL_MAX_WIDTH, N as getDefaultShareViewBaseUrl, O as DEFAULT_MAX_CONCURRENCY, P as getShareApiBaseUrl, R as FILE_METADATA_KEY, S as parseChatPrompt, c as cloudConfig, f as getCurrentTimestamp, h as REQUEST_TIMEOUT_MS, k as DEFAULT_QUERY_LIMIT, n as fetchWithRetries, p as sleep, r as fetchWithTimeout, s as CloudConfig, t as fetchWithProxy, y as isPromptfooSampleTarget, z as HUMAN_ASSERTION_TYPE } from "./fetch-BIfcW-Fd.js";
import { a as fetchWithCache, o as getCache, r as disableCache, t as cache_exports } from "./cache-BMl3AIo5.js";
import { A as createRateLimitRegistry, B as resolveTeamId, C as collectFileMetadata, D as loadFromPackage, E as isPackagePath, F as getCloudDatabaseId, I as getOrgContext, J as AIStudioChatProvider, L as getPluginSeverityOverridesFromCloud, M as PromptfooHarmfulCompletionProvider, O as redteamProviderManager, P as checkCloudPermissions, T as runExtensionHook, _ as extractVariablesFromJson, a as resolveProviderConfigs, b as isBasicRefusal, c as Strategies, d as pluginMatchesStrategyTargets, f as checkExfilTracking, g as extractPromptFromTags, i as resolveProvider, j as createProviderRateLimitOptions, k as TokenUsageTracker, l as loadStrategy, m as extractGoalFromPrompt, n as loadApiProvider, o as MCPProvider, q as VertexChatProvider, r as loadApiProviders, s as GoogleLiveProvider, t as getProviderIds, u as validateStrategies, v as getSessionId, w as renderPrompt, y as getShortPluginId, z as isCloudProvider } from "./providers-Co_FGgH8.js";
import { i as generateIdFromPrompt, t as hashPrompt } from "./utils-BryuD3vq.js";
import { a as sha256, i as randomSequence, n as isBlobStorageEnabled, t as extractAndStoreBinaryData } from "./extractor-Da8IxCeS.js";
import "./genaiTracer-Ce19n68P.js";
import { t as OpenAiChatCompletionProvider } from "./chat-DDGU7Tik.js";
import { a as createEmptyTokenUsage, i as createEmptyAssertions, n as accumulateResponseTokenUsage, o as normalizeTokenUsage, r as accumulateTokenUsage, t as accumulateAssertionTokenUsage } from "./tokenUsageUtils-cFdLMERB.js";
import { p as validateFunctionCall } from "./transform-BUrxadlA.js";
import "./messages-CJgEjRQF.js";
import "./util-CfepsNVK.js";
import "./openai-CitF-gEN.js";
import { l as validateFunctionCall$1 } from "./util-Bnw6EyZN.js";
import "./completion-1RAiLcwi.js";
import { c as setUserEmail, i as getUserEmail, l as EMAIL_OK_STATUS, r as getAuthor, s as promptForEmailUnverified, t as checkEmailStatusAndMaybeExit } from "./accounts-DxR9x_En.js";
import { i as getRemoteGenerationUrl, l as shouldGenerateRemote, o as getRemoteHealthUrl, r as promptYesNo, s as neverGenerateRemote } from "./server-BF3HkMhe.js";
import { t as getBlobByHash } from "./blobs-Dcm272OH.js";
import { a as evalsTable, c as evalsToTagsTable, d as tagsTable, i as evalResultsTable, l as promptsTable, m as getDbSignalPath, o as evalsToDatasetsTable, p as getDb, r as datasetsTable, s as evalsToPromptsTable } from "./tables-Dwexr5Z6.js";
...
async function startOtlpReceiverIfNeeded(testSuite) {
	...
	if (testSuite.tracing?.enabled && testSuite.tracing?.otlp?.http?.enabled && !otlpReceiverStarted) {
		...
		try {
			...
			const { startOTLPReceiver } = await import("./otlpReceiver-DRNetlJH.js");
...
async function stopOtlpReceiverIfNeeded() {
	if (otlpReceiverStarted) try {
		...
		const { stopOTLPReceiver } = await import("./otlpReceiver-DRNetlJH.js");
...
async function generateTraceContextIfNeeded(test, evaluateOptions, testIdx, promptIdx, testSuite) {
	...
	const { getTraceStore } = await import("./store-KXWnHB15.js");
...
const ASSERTION_HANDLERS = {
	...
	meteor: async (params) => {
		try {
			const { handleMeteorAssertion } = await import("./meteor-CBciquOS.js");
...
async function runAssertion({ prompt, provider, assertion, test, vars, latencyMs, providerResponse, traceId }) {
	...
	if (typeof renderedValue === "string") if (renderedValue.startsWith("file://")) {
		...
		if (isJavascriptFile(filePath)) {
			...
			const { runRuby } = await import("./rubyUtils-_t9Gmf7U.js");
	...
	*/
	...
	async _runEvaluation() {
		...
		for (let index = 0; index < tests.length; index++) {
			...
			if (!testCase.provider && typeof testSuite.defaultTest === "object" && testSuite.defaultTest?.provider) {
				...
				if (isApiProvider(defaultProvider)) testCase.provider = defaultProvider;
					...
					const { loadApiProvider } = await import("./providers-41mSodR_.js");
		...
		if (cliState_default.resume && this.evalRecord.persisted) try {
			const { default: EvalResult } = await import("./evalResult-C8iVgVvr.js");
...
async function resolveConfigs(cmdObj, _defaultConfig, type) {
	...
	if (cmdObj.filterPrompts) {
		...
		if (parsedPrompts.length === 0) logger_default.warn(`No prompts matched the filter "${cmdObj.filterPrompts}". Check your --filter-prompts value.`);
	}
