...
function initializeRunLogging() {
	try {
		...
		if (!getEnvBool("PROMPTFOO_DISABLE_DEBUG_LOG", false)) {
			cliState_default.debugLogFile = createRunLogFile("debug", { date });
			const runLogTransport = new winston.transports.File({
				filename: cliState_default.debugLogFile,
				level: "debug",
		...
		if (!getEnvBool("PROMPTFOO_DISABLE_ERROR_LOG", false)) {
			cliState_default.errorLogFile = createRunLogFile("error", { date });
			const errorLogTransport = new winston.transports.File({
				filename: cliState_default.errorLogFile,
				level: "error",
				format: winston.format.combine(winston.format.simple(), fileFormatter)
			});
...
//#endregion
export { getEnvString as C, isNonInteractive as D, isCI as E, cliState_default as O, getEnvInt as S, getMaxEvalTimeMs as T, summarizeEvaluateResultForLogging as _, logRequestResponse as a, getEnvBool as b, setLogLevel as c, extractFirstJsonObject as d, extractJsonObjects as f, safeJsonStringify as g, orderKeys as h, isDebugEnabled as i, sanitizeObject as l, isValidJson as m, getLogLevel as n, logger_default as o, getAjv as p, initializeRunLogging as r, setLogCallback as s, closeLogger as t, sanitizeUrl as u, getConfigDirectoryPath as v, getEvalTimeoutMs as w, getEnvFloat as x, setConfigDirectoryPath as y };
//# sourceMappingURL=logger-Bzi5o47S.js.map